...
from cigs.llm.references import References  # noqa: F401
from cigs.memory.assistant import AssistantMemory, MemoryRetrieval, Memory  # noqa: F401
from cigs.prompt.template import PromptTemplate
from cigs.storage.assistant import AssistantStorage
from cigs.utils.format_str import remove_indent
...
class Assistant(BaseModel):
    ...
    def _api_log_assistant_run(self):
        ...
        from cigs.api.assistant import create_assistant_run, AssistantRunCreate
    ...
    def _api_log_assistant_event(self, event_type: str = "run", event_data: Optional[Dict[str, Any]] = None) -> None:
        ...
        from cigs.api.assistant import create_assistant_event, AssistantEventCreate
