...
from cigs.assistant.openai.run import Run
from cigs.assistant.openai.message import Message
from cigs.assistant.openai.assistant import OpenAIAssistant
from cigs.assistant.openai.exceptions import ThreadIdNotSet
...
class Thread(BaseModel):
    ...
    def print_messages(self) -> None:
        ...
        from cigs.cli.console import console
