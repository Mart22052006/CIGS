...
from cigs.assistant.openai.file import File
from cigs.assistant.openai.exceptions import AssistantIdNotSet
from cigs.tools import Tool, Toolkit
from cigs.tools.function import Function
...
class OpenAIAssistant(BaseModel):
    ...
    #     from cigs.assistant.openai.thread import Thread
    #
