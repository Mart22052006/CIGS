...
from cigs.app.base import AppBase  # noqa: F401
from cigs.app.context import ContainerContext
...
if TYPE_CHECKING:
    ...
    from cigs.aws.resource.ecs.container import EcsContainer
...
class AwsApp(AppBase):
    ...
    def get_load_balancer_security_groups(self) -> Optional[List["SecurityGroup"]]:
        from cigs.aws.resource.ec2.security_group import SecurityGroup, InboundRule
    ...
    def security_group_definition(self) -> "SecurityGroup":
        from cigs.aws.resource.ec2.security_group import SecurityGroup, InboundRule
        from cigs.aws.resource.reference import AwsReference
    ...
    def build_resources(self, build_context: AwsBuildContext) -> List["AwsResource"]:
        ...
        from cigs.aws.resource.ecs.task_definition import EcsTaskDefinition
        from cigs.aws.resource.ecs.service import EcsService
        from cigs.aws.resource.ecs.volume import EcsVolume
        from cigs.docker.resource.image import DockerImage
        from cigs.utils.defaults import get_default_volume_name
