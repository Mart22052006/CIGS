...
from cigs.aws.app.base import AwsApp
from cigs.aws.app.context import AwsBuildContext
from cigs.aws.api_client import AwsApiClient
...
class AwsResources(InfraResources):
    ...
    def get_aws_region(self) -> Optional[str]:
        ...
        from cigs.constants import AWS_REGION_ENV_VAR
    ...
    def get_aws_profile(self) -> Optional[str]:
        ...
        from os import getenv
        from cigs.constants import AWS_PROFILE_ENV_VAR
    ...
    def create_resources(
        ...
        from cigs.aws.resource.types import AwsResourceInstallOrder
