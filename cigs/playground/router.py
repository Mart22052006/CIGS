...
from cigs.agent.agent import Agent, RunResponse
from cigs.agent.session import AgentSession
from cigs.workflow.workflow import Workflow
from cigs.workflow.session import WorkflowSession
from cigs.playground.operator import (
    format_tools,
    get_agent_by_id,
    get_session_title,
...
from cigs.services.agent_service import check_by_role
from cigs.playground.schemas import (
    AgentGetResponse,
        ...
        if files:
            for file in files:
                if file.content_type == "application/pdf":
                    from cigs.document.reader.pdf import PDFReader
                    ...
                    from cigs.document.reader.csv_reader import CSVReader
                    ...
                    from cigs.document.reader.text import TextReader
