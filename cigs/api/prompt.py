...
from cigs.api.schemas.prompt import (
    PromptRegistrySync,
    PromptTemplatesSync,
...
from cigs.api.schemas.workspace import WorkspaceIdentifier
from cigs.constants import WORKSPACE_ID_ENV_VAR, WORKSPACE_KEY_ENV_VAR
