...
from cigs.api.schemas.team import TeamSchema
from cigs.api.schemas.workspace import WorkspaceSchema
from cigs.workspace.settings import WorkspaceSettings
from cigs.utils.py_io import get_python_objects_from_module
...
def get_workspace_objects_from_file(resource_file: Path) -> dict:
    ...
    from cigs.aws.resources import AwsResources
    from cigs.docker.resources import DockerResources
    ...
    try:
        ...
        if not aws_resources_available and create_default_aws_resources:
            from cigs.aws.resources import AwsResource, AwsApp
