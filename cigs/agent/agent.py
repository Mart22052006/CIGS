...
from cigs.model.content import Image, Video, Audio
from cigs.reasoning.step import ReasoningStep, ReasoningSteps, NextAction
from cigs.run.response import RunEvent, RunResponse, RunResponseExtraData
...
from cigs.memory.agent import AgentMemory, MemoryRetrieval, Memory, AgentRun, SessionSummary  # noqa: F401
from cigs.prompt.template import PromptTemplate
from cigs.storage.agent.base import AgentStorage
from cigs.tools import Tool, Toolkit, Function
from cigs.utils.log import logger, set_log_level_to_debug, set_log_level_to_info
from cigs.utils.message import get_text_from_message
from cigs.utils.merge_dict import merge_dictionaries
...
class Agent(BaseModel):
    ...
    def log_agent_session(self):
        ...
        from cigs.api.agent import create_agent_session, AgentSessionCreate
    ...
    async def alog_agent_session(self):
        ...
        from cigs.api.agent import acreate_agent_session, AgentSessionCreate
    ...
    def log_agent_run(self) -> None:
        ...
        from cigs.api.agent import create_agent_run, AgentRunCreate
    ...
    async def alog_agent_run(self) -> None:
        ...
        from cigs.api.agent import acreate_agent_run, AgentRunCreate
