...
from cigs.utils.log import logger, set_log_level_to_debug
...
def create(
    ...
    from cigs.workspace.operator import create_workspace
...
def setup(
    ...
    from cigs.workspace.operator import setup_workspace
...
def up(
    ...
    from cigs.workspace.operator import start_workspace, setup_workspace
    from cigs.workspace.helpers import get_workspace_dir_path
    from cigs.utils.resource_filter import parse_resource_filter
...
def down(
    ...
    from cigs.cli.operator import initialize_phi
    from cigs.workspace.config import WorkspaceConfig
    from cigs.workspace.operator import stop_workspace, setup_workspace
    from cigs.workspace.helpers import get_workspace_dir_path
    from cigs.utils.resource_filter import parse_resource_filter
...
def patch(
    ...
    from cigs.cli.operator import initialize_phi
    from cigs.workspace.config import WorkspaceConfig
    from cigs.workspace.operator import update_workspace, setup_workspace
    from cigs.workspace.helpers import get_workspace_dir_path
    from cigs.utils.resource_filter import parse_resource_filter
...
def config(
    ...
    from cigs.cli.operator import initialize_phi
    from cigs.workspace.config import WorkspaceConfig
    from cigs.utils.load_env import load_env
...
def delete(
    ...
    """\b
    Deletes the workspace record from cigs.
    ...
    from cigs.cli.config import PhiCliConfig
    from cigs.cli.operator import initialize_phi
    from cigs.workspace.operator import delete_workspace
