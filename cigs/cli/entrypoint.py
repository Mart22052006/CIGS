...
from cigs.cli.ws.ws_cli import ws_cli
from cigs.utils.log import set_log_level_to_debug, logger
...
def auth(
    ...
    from cigs.cli.operator import authenticate_user
...
def login(
    ...
    * `phi login`
    ...
    from cigs.cli.operator import sign_in_using_cli
...
def ping(
    ...
    from cigs.api.user import user_ping
    from cigs.cli.console import print_info
...
def set(
    ...
    """
    from cigs.workspace.operator import set_workspace_as_active
...
def start(
    ...
    from cigs.cli.config import PhiCliConfig
    from cigs.cli.console import log_config_not_available_msg
    from cigs.cli.operator import start_resources, initialize_phi
...
def stop(
    ...
    from cigs.cli.config import PhiCliConfig
    from cigs.cli.console import log_config_not_available_msg
    from cigs.cli.operator import stop_resources, initialize_phi
    from cigs.infra.type import InfraType
...
def patch(
    ...
    from cigs.cli.config import PhiCliConfig
    from cigs.cli.console import log_config_not_available_msg
    from cigs.cli.operator import patch_resources, initialize_phi
    from cigs.infra.type import InfraType
