...
from cigs.cli.settings import phi_cli_settings, PHI_CLI_DIR
from cigs.cli.config import PhiCliConfig
from cigs.cli.console import print_info, print_heading
...
def delete_phidata_conf() -> None:
    from cigs.utils.filesystem import delete_from_fs
...
def authenticate_user() -> None:
    ...
    from cigs.api.schemas.user import UserSchema
    from cigs.cli.credentials import save_auth_token
    from cigs.cli.auth_server import (
...
def sign_in_using_cli() -> None:
    ...
    from cigs.api.user import sign_in_user
    from cigs.api.schemas.user import UserSchema, EmailPasswordAuthSchema
