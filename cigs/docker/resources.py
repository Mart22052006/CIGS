...
from cigs.app.group import AppGroup
from cigs.resource.group import ResourceGroup
from cigs.docker.app.base import DockerApp
from cigs.docker.app.context import DockerBuildContext
from cigs.docker.api_client import DockerApiClient
...
class DockerResources(InfraResources):
    ...
    def create_resources(
        ...
        from cigs.cli.console import print_info, print_heading, confirm_yes_no
        from cigs.docker.resource.types import DockerContainer, DockerResourceInstallOrder
